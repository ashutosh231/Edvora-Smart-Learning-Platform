...
import { updateCourseProgress, getProgressPercentage, claimCourseCertificate } from "../controllers/CourseProgress.js";
...
// Claim Certificate
router.post("/claimCertificate", auth, isStudent, claimCourseCertificate);
